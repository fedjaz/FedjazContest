...
namespace FedjazContest.Models
{
    public class RegistrationModel
    {
        ...
        [Remote(controller: "Account", action: "CheckUsername", ErrorMessage = "Username is already in use")]
        public string Username { get; set; } = "";

        [Required(AllowEmptyStrings = false, ErrorMessage = "Enter your Email")]
        [EmailAddress(ErrorMessage = "Email is invalid")]
        [Remote(controller: "Account", action: "CheckEmail", ErrorMessage = "Email is already in use")]
